...
AJeninUnit::AJeninUnit()
{
	...
	// static ConstructorHelpers::FObjectFinder<UMaterial> MaterialAsset(TEXT("Material'/Game/App/Materials/MAT_JeninSelectionDecal.MAT_JeninSelectionDecal'")); 
	// if (MaterialAsset.Succeeded())
	// {
	// 	DecalComponent->SetDecalMaterial(MaterialAsset.Object);
	// }
	//
}
